...
export const SimulacraCard = ({data}: ICardSimulacraSimple) => {
  return (
    ...
    href={`/simulacra/${data.id}`}>
      <div className='bg-no-repeat rounded-lg w-full h-full bg-cover bg-center ease-in-out duration-[250ms] delay-0  group-hover:scale-110' style={{backgroundImage: `url(https://api.toweroffantasy.info${data.assetsA0.painting})`}}/>
